...
<td  style="border-right:solid 2px;<?php echo $ak;?>"> ECS (Our company) </td>
 

 <td style="<?php echo $bk;?>"> <?php
$company_id = $_GET['company_id'];
...
<td style="border-right:solid 2px;<?php echo $ak;?>">
...
<tr>
<td> Totals : </td>  <td> &nbsp; </td> <td> &nbsp; </td> <td> <?php echo $mycompanytotalinvAmount ;?></td> 
<td> &nbsp; </td> <td> <?php echo $mycompanytotalPaidAmount;?></td>
</tr>
...
?>
<tr>
<td> Totals :&nbsp; </td>  <td> &nbsp; </td> <td> &nbsp; </td> <td> <?php echo $othercompanytotalinvAmount ;?> </td>
 <td> &nbsp; </td> <td> <?php echo $othercompanytotalPaidAmount;?> </td>
</tr>
...
<tr> 
<td style="text-align:center;border-right:solid 2px"> Balance :  <?php echo $mycompanytotalinvAmount ;?> &nbsp; </td> 
<td style="text-align:center" > Balance :  <?php echo $othercompanyBalanceAmount ;?>&nbsp;</td> 
</tr>
