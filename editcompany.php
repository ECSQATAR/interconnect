    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
		...
		<div class="row">
 	    ...
 	    <input name="Manufaturere_Model" value="<?php echo  $rownew->Manufaturere_Model;?>"  type="text" class="form-control" required placeholder="Enter Manufaturere/Model" />       	 
		</div>

		 <div class="col-md-6 col-sm-12 col-ls-6">
		    <label>      IP address    </label>   
		    <input name="ip_address"  type="text"  value="<?php echo  $rownew->ip_address;?>"  class="form-control" required  placeholder="Enter IP address" />  
    	 	</div>
	</div>
			...
			<div class="col-md-6 col-sm-12 col-ls-6">
			 ...
			 <select  name="protocols"  class="form-control" required >
				<option value="">Select Protocol</option> 
 				 <option value="H323" <?php if($rownew->protocols=='H323') echo 'selected'; ?> >H323</option> 
				 <option value="SIP"  <?php if($rownew->protocols=='SIP') echo 'selected'; ?> >SIP</option>
				  <option value="IAX" <?php if($rownew->protocols=='IAX') echo 'selected'; ?> >IAX</option>
 			...
 			<div class="col-md-6 col-sm-12 col-ls-6">
 			    ...
 			    <label>    Ports  </label>   
			    <input name="ports"  type="text" value="<?php echo  $rownew->ports;?>"   class="form-control"  value="5060"   placeholder="Ports required" />  
	    	 	</div>
...
<div class="row">
 			...
 			<div class="col-md-6 col-sm-12 col-ls-6">
			    ...
			    <input name="tech_prefix"  type="text" value="<?php echo  $rownew->tech_prefix;?>"   class="form-control"    placeholder="Enter tech prefix" />  
	    	 	</div>
			...
			<div class="col-md-6 col-sm-12 col-ls-6">
			  ...
			  <br>
		<?php
			  $codecs_supported = $rownew->codecs_supported;
			  $codecs_supportedData = 	explode(",",$codecs_supported);
			  $codecsList = array('G723','G729','G711a','G711u','GSM');
			  foreach($codecsList as $codes){
		?>	
		<input type="checkbox" name="codecs_supported[]" value="<?php echo $codes;?>" <?php if(array_search($codes, $array)>=0)) echo 'checked';?> > <?php echo $codes;?><br>
		<?php
			  }
	    ?> 
...
<div class="row">
			 ...
			 <div class="col-md-6 col-sm-12 col-ls-6">
			    ...
			    <input name="Calling_Number_Format"  type="text"  value="<?php echo  $rownew->Calling_Number_Format;?>"  class="form-control"    placeholder="Enter  Calling Number Format" />  
	    	 	</div>
	
			 <div class="col-md-6 col-sm-12 col-ls-6">
 			    <label>     Called Number Format    </label>   
			    <input name="Called_Number_Format"  type="text"  value="<?php echo  $rownew->Called_Number_Format;?>"  class="form-control"    placeholder="Enter Called Number Format"/>  
	    	 	</div>
	...
	<div class="row">
		...
		$(function() {
			...
			<input id="paypal" name="paypal" value="yes" type="checkbox" <?php if($rownew->paypal=='yes') echo 'checked' ;?> />
			 <label>     Paypal  </label>   
 	    	 	</div>


 			<div class="col-md-4 col-sm-12 col-ls-4">
 			    	<input id="Skrill" name="Skrill"  value="yes" type="checkbox" <?php if($rownew->Skrill=='yes') echo 'checked' ;?> />
				<label>   Skrill  </label>   
 			</div>

			 <div class="col-md-4 col-sm-12 col-ls-4">
 			     <input id="Western_union" name="Western_union"  value="yes" type="checkbox" <?php if($rownew->Western_union=='yes') echo 'checked' ;?>  />
	...
	<div class="row">
			 ...
			 <div class="col-md-4 col-sm-12 col-ls-4">
 			    <input id="wire_transform" name="wire_transform" value="yes" type="checkbox"  <?php if($rownew->wire_transform=='yes') echo 'checked' ;?> >
			  <label>      Wire transform    </label>   
  	    	 	</div>

			 <div class="col-md-4 col-sm-12 col-ls-4">
 			     <input id="Local_Bank_Deposit" name="Local_Bank_Deposit" value="yes" type="checkbox" <?php if($rownew->Local_Bank_Deposit=='yes') echo 'checked' ;?>  >
...
/// echo "<pre>";	print_r($_POST);
	...
	$companyaddress= mysql_escape_string( $_POST['companyaddress']);
