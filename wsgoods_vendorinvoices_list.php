...
if (confirm('Are you sure you want to Remove ?')) {
    window.location.href = "wsgoods_vendorinvoices_list.php?action=delete&id="+id;
    // Save it!
} 
...
if (confirm('Are you sure you want to Lock the invoice ?')) {
    window.location.href = "wsgoods_vendorinvoices_list.php?action=lock&id="+id;
    // Save it!
} 
...
//print_r($_GET);
	$id = $_GET['id'];
	$sqldelete = "DELETE from  ws_goodservice_vendorinvoice_master where id=$id";
...
//print_r($_GET);
	$id = $_GET['id'];
	$sqldelete = "update  ws_goodservice_vendorinvoice_master set lockedinvoice=1  where id=$id";
	mysql_query($sqldelete); 
	//header("Location:prefixmasterlist.php");
	//exit(0);
}
...
<h1>Vendor Other Goods service Invoices List </h1>
...
$sumtotalinv = 0;
   $sql = "SELECT * From ws_goodservice_vendorinvoice_master $condition $sortByData  ";
 $result = mysql_query($sql);
$sno = 0;
...
?>
&nbsp;
<a href="<?php echo 'editgoodsvendorinvoice.php?lastInserId='.$rowinv->id;?>"> <img src="invedit3.png" width="20" height="20"   title="edit Invoice"/> </a> &nbsp;
&nbsp;
 


	 <a href="<?php echo 'generategoodsvendorinvoicepdf.php?id='.$rowinv->id;?>"> <img src="geneatepdf.png" width="20" height="20"   title="Generater Pdf"/> </a> &nbsp;
