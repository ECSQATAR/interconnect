...
if(isset($_GET['action']) && $_GET['action'] == 'delete'){
	$did = $_GET['id'];
	$sqld = "delete from tempwholeconsumeddata where id=$did";
	mysql_query($sqld);
...
<div class="container">
<h2>Confirm Consumed minutes Data </h2>
<div class="row">
...
while($row = mysql_fetch_object($result)){
	...
	<td> <a href="<?php echo 'showimportconsumeddata.php?action=delete&id='.$row->id;?>"> Delete </a> </td>
...
?>	
 <tr> <td colspan='10'>  Minutes Consumed mm:ss <?php echo $totalbiledduration;?>  &nbsp; charged Amount : <?php echo $totalchargedamount; ?> </td> </tr>

 <tr> <td colspan='10'> <a href="generateconsumptionreport.php">Generate Consumption Report </a> </td> </tr>
